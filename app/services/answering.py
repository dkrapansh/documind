...
SYSTEM_PROMPT = (
    ...
    "I don't have enough relevant information in the uploaded documents "
    "to answer that question confidently.\n\n"
    "Write in plain prose. Do not use markdown: no asterisks for bold, no "
    "bullet lists, no headings. The client renders your reply as plain text, "
    "so markdown syntax appears literally as punctuation. Where the answer "
    "is naturally a list, write it as a sentence with the items separated by "
    "commas or semicolons.\n\n"
    "Be concise. Answer what was asked and stop. Do not restate the whole "
    "document when the question asks about part of it.\n\n"
